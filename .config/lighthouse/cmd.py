...
special = {
    ...
    "chrome": (lambda x: ("chrome","chromium")),
}
...
while 1:
    ...
    try:
        ...
        # Could be a command...
        append_output("google '"+userInput+"'", "xdg-open http://www.google.no/search?q=" + urlify(userInput))

        append_output("url '"+userInput+"'", "xdg-open http://www." + urlify(userInput))

        append_output("bing videos '"+userInput+"'", "xdg-open https://www.bing.com/videos/search?q=" + urlify(userInput))
